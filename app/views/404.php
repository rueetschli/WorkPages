...
<head>
    ...
    <title><?= Security::esc(t('errors.not_found')) ?> - <?= Security::esc($appName) ?></title>
...
<body class="error-body">
    <div class="error-container">
        ...
        <p class="error-message"><?= Security::esc(t('errors.not_found')) ?></p>
        <p style="margin: 1rem 0; color: var(--color-text-secondary);"><?= Security::esc(t('errors.not_found_text')) ?></p>
