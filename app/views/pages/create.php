...
<div class="page-header">
    <h1><?= Security::esc(t('pages.create_title')) ?></h1>
    <p class="subtitle"><?= Security::esc(t('pages.create_subtitle')) ?></p>
</div>
    ...
    <form method="post" action="<?= Security::esc($baseUrl) ?>/?r=page_create" class="page-form">
        ...
        <div class="form-group">
            ...
            <textarea id="content_md" name="content_md" class="form-input form-textarea"
                      rows="18" data-mentions="true" data-context="page" data-easymde="true"><?= Security::esc($formData['content_md']) ?></textarea>
            <span class="textarea-hint"><?= Security::esc(t('pages.textarea_hint')) ?></span>
        </div>

        <div class="form-actions">
            <button type="submit" class="btn btn-primary"><?= Security::esc(t('pages.create_button')) ?></button>
            <a href="<?= Security::esc($baseUrl) ?>/?r=pages" class="btn btn-secondary"><?= Security::esc(t('actions.cancel')) ?></a>
        </div>
    </form>
</div>
